...
const LongCard = () => {
  return (
   <div>
     <h2 className="mt-4 ms-3 mb-4 text-center" >MEDAL WORTHY BRANDS TO BAG</h2>
    <div className="card-group ms-3 ">
      <div className="card">
        ...
        <div className="card-body text-center">
          ...
          UNSTOPPABLE COMFORT
          <h5 className="card-title fs-6 fw-bold">MIN 40-60% OFF</h5>
          </p>
        </div>
      </div>
      <div className="card">
        ...
        <div className="card-body text-center">
          ...
          <h5 className="card-title fs-6 fw-bold">FLAT 70% OFF</h5>
          </p>
      ...
      <div className="card">
        ...
        <div className="card-body text-center">
          ...
          <h5 className="card-title fs-6 fw-bold">MIN 30-60% OFF</h5>
          </p>
      ...
      <div className="card">
        ...
        <div className="card-body text-center">
          ...
          <p className="card-text">
           TRENDING FOOTWEAR
          <h5 className="card-title fs-6 fw-bold">FLAT 85% OFF</h5>
          </p>
      ...
      <div className="card">
        ...
        <div className="card-body text-center">
          ...
          <p className="card-text">
          EVERYDAY GO-TO-FIND
          <h5 className="card-title fs-6 fw-bold">MIN 50-70% OFF</h5>
          </p>
