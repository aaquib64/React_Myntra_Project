                        ...
                        <div className="container-fluid" >
                            <div className="Navbar-Container" >
                                <ul  className="Nav-Tags">
                                    ...
                                    <Bag/>
                                    {/* <li >
                                        <a  className="Nav-icon"  href="https://www.myntra.com/">
                                    ...
                                    {/* <li  className="Nav-Tag-1">
                                        <a  aria-current="page" href="https://www.myntra.com/shop/men" className="Anchor-tag">MEN</a>
                                    </li> */}
                                    {/* <li className="Nav-Tag-All" >
                                        <a  aria-current="page" href="https://www.myntra.com/shop/women" className="Anchor-tag">WOMEN</a>
                                    </li> */}
                                    {/* <li className="Nav-Tag-All">
                                        <a aria-current="page" href="https://www.myntra.com/shop/kids" className="Anchor-tag">KIDS</a>
                                    </li> */}
                                    {/* <li className="Nav-Tag-All">
                                        <a  aria-current="page" href="https://www.myntra.com/shop/home-living" className="Anchor-tag">HOME & LIVING</a>
                                    </li> */}
                                    {/* <li className="Nav-Tag-All">
                                        <a aria-current="page" href="https://www.myntra.com/personal-care" className="Anchor-tag">BEAUTY</a>
                                    </li> */}
                                    {/* <li  className="Nav-Tag-All">
                                        <a  aria-current="page" href="https://www.myntra.com/studio/home" className="Anchor-tag">STUDIO</a>
                                    </li> */}
                                    ...
                                    {/* <li  className="Nav-Tag-Right">
                                        <a className="nav-link active" aria-current="page" href="http://127.0.0.1:5500/Login.html">Profile</a>
                                    </li> */}
                                    {/* <li  className="Nav-Tag-Right">
